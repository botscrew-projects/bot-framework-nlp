...
public class JsonElementToIntegerConverter implements ArgumentConverter<JsonElement> {
    private static final ConverterKey KEY = ConverterKey.of(JsonElement.class, ArgumentType.PARAM_INTEGER);
